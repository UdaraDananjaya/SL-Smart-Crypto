$(function () {
    ...
    $(window).on('scroll', function (event) {
        ...
        if (scroll < 110) {
            ...
            $(".header-menu-1 img").attr("src", "img/logo.png");
            $(".header-menu-2 img").attr("src", "img/logo-4.png");
            $(".header-menu-4 img").attr("src", "img/logo-7.png");
        } else {
            $(".header-menu").addClass("sticky");
            $(".header-menu-1 img").attr("src", "img/logo-3.png");
            $(".header-menu-2 img").attr("src", "img/logo-5.png");
            $(".header-menu-4 img").attr("src", "img/logo-8.png");
        }
    });
